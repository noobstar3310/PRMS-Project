...
<html lang="en">
    ...
    <head>
        ...
        button {
            ...
            cursor: pointer;
            font-size: 16px;
            margin: 10px 0; /* Add some space around the buttons */
        }
    ...
    <form action="pjr_sow_dashboard.php" method="post">
        ...
        <button type="button" onclick="window.location.href = 'pjr_sow_dashboard.php'">PJR-SOW</button>
    </form>
    <form action="upload_page.php" method="post">
        <!-- Your form fields go here -->
        <button type="button" onclick="window.location.href = 'upload_page.php'">Append File</button>
    </form>
</div>
